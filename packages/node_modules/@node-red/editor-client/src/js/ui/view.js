                ...
                if (d.dirty) {
                    ...
                    if (mouse_mode != RED.state.MOVING_ACTIVE) {
                        ...
                        if ((!isLink || (showAllLinkPorts === -1 && !activeLinkNodes[d.id])) && d.inputs === 0 && !inputPorts.empty()) {
                            inputPorts.remove();
                        } else if (((isLink && (showAllLinkPorts===PORT_TYPE_INPUT||activeLinkNodes[d.id]))|| d.inputs > 0) && inputPorts.empty()) {
                            for (var portIndex = 0; portIndex < d.inputs; portIndex++ ) {
                                var inputGroup = document.createElementNS("http://www.w3.org/2000/svg","g");
                                inputGroup.setAttribute("class", "red-ui-flow-port-input");
                                var inputGroupPorts;
                                ...
                                if (d.type === "link in") {
                                    ...
                                    inputGroupPorts.setAttribute("rx",3);
                                    inputGroupPorts.setAttribute("ry",3);
                                ...
                                var y = (d.h/2)-((d.inputs-1)/2)*13;
                                inputGroup.setAttribute("transform","translate(-5,"+((y+13*portIndex)-5)+")");
